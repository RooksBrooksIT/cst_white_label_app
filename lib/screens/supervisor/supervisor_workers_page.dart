                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    const Color(0xFFF57C00).withValues(alpha: 0.18),
                                    const Color(0xFFF57C00).withValues(alpha: 0.06),
                                  ],
                                  begin: Alignment.topLeft,
                                  end: Alignment.bottomRight,
                                ),
                            ...
                            const Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 2),
                                  Text(
                                    'Manage daily labour check-ins, monitor workforce presence and generate wage reports.',
                                    style: TextStyle(
                                      fontSize: 12,
